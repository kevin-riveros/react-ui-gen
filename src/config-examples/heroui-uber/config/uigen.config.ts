...
/**
 * HeroUI with a Uber-inspired theme.
 *
 ...
 * "Uber" preset from https://heroui.com/themes into that file.
 *
...
const config: UIGenConfig = {
  brand: {
    name: "UI Gen — Uber",
    tagline:
      "Uber-inspired utility UIs — clean monochrome, functional type hierarchy",
    chatPlaceholder:
      "Describe a page or component and I'll build it with HeroUI + the Uber theme.",
    previewDomain: "uber.com",
  },
  ds: {
    name: "heroui-uber",
    tailwind: true,
